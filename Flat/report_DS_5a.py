...
inp_dir = r"G:\Flat"
# inp_dir = r"D:\Flat"
# "D:\Flat\Flat_Arn.xlsx"
excel_file = "Flat_Arn.xlsx"
# excel_file = "Flat_Arn1.xlsx"
sheet_name = "Push"
...
# Запись отчета в Excel (опционально)
write_report_to_excel(file_path, report_data, suffix, title.replace("__", month_name).replace("++++", str(year)))