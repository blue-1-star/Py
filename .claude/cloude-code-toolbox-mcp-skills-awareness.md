...
_Generated: 2026-06-29T06:43:15.412Z_
...
Workspace `mcp.json` _(folder: Py)_

- **g:\Programming\Py\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\first\.claude.json** — _File exists — no servers defined_
