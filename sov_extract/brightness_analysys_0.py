...
def calculate_brightness_dataframe(image_dir, lower_threshold, size):
    ...
    for img_file in image_files:
        ...
        brightness_pil = calculate_brightness_pil(img, lower_threshold)
        brightness_color = calculate_brightness_color(img, lower_threshold)
...
if __name__ == "__main__":
    ...
    cache_file = os.path.join(image_dir, "brightness_data1.csv")
