...
def add_data():
    ...
    if sheet[f"{total_inc_col}{row}"].coordinate:
    ...
    if sheet[f"{total_tax_col}{row}"].coordinate:
    ...
    if sheet[f"{prev_tax_col}{row}"].coordinate:
    ...
    if sheet[f"{tax_pay_col}{row}"].coordinate:
